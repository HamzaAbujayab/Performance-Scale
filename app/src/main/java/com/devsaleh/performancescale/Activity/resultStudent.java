...
public class resultStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linear1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i1 = new Intent(getApplicationContext(), selectSubject_H.class);
                String resultTvRight = (String) binding.resultTvRight.getText();
                i1.putExtra("resultTv", resultTvRight);
                startActivity(i1);
        ...
        linear2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i2 = new Intent(getApplicationContext(), selectSubject_H.class);
                String resultTvCenter = (String) binding.resultTvCenter.getText();
                i2.putExtra("resultTv", resultTvCenter);
                startActivity(i2);
            }
        });
        ...
        linear3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i3 = new Intent(getApplicationContext(), selectSubject_H.class);
                String resultTvLeft = (String) binding.resultTvLeft.getText();
                i3.putExtra("resultTv", resultTvLeft);
                startActivity(i3);
            }
        });
    ...
    private void getMyMovementsMethod() {
        ...
        postViewModel.MldParentAverage.observe(resultStudent.this, new Observer<ParentAverage>() {
            @Override
            public void onChanged(ParentAverage parentAverage) {
                ...
                ExpectedGpa(allQuizesAvg, sub1_avg, sub2_avg, sub3_avg, sub4_avg, sub5_avg, sub6_avg, sub7_avg, sub8_avg, sub9_avg, sub12_avg);
            }
        });
    }

    private void ExpectedGpa(String allQuizesAvg, String sub1_avg, String sub2_avg, String sub3_avg, String sub4_avg, String sub5_avg, String sub6_avg, String sub7_avg,
                             String sub8_avg, String sub9_avg, String sub12_avg) {
        postViewModel.expected_gpa(sub1_avg, sub2_avg, sub7_avg, sub12_avg, sub3_avg, sub5_avg, sub4_avg, sub6_avg, sub9_avg, sub8_avg);
        postViewModel.MldExpectedGpa.observe(resultStudent.this, new Observer<ExpectedGpa>() {
            @Override
    ...
    private void Performance(double gpa0, String assessment) {
        ...
        postViewModel.MldPerformance.observe(resultStudent.this, new Observer<Performance>() {
            @Override
